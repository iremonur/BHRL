...
seq_cls = "helicopter"
path = "/truba/home/ionur/BHRL/vot_annotation/{}/vot_{}_test.json". format(seq_cls, seq_cls)
save_path = "/truba/home/ionur/BHRL/vot_annotation/ft/{}_first_ft.json". format(seq_cls)
...
# cnt = 2
# for root, dirs, files in os.walk("/truba/home/ionur/BHRL/vot_annotation/", topdown=False):
#     for file in files:
